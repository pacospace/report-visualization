...
def _get_version():
    with open(os.path.join("thoth", "report_visualization", "__init__.py")) as f:
        content = f.readlines()
...
setup(
    name="thoth-report-visualization",
    version=VERSION,
    description="Code for visualizing processed report from Thoth components.",
    long_description=Path("README.rst").read_text(),
    long_description_content_type="text/x-rst",
    author="Francesco Murdaca",
    author_email="fmurdaca@redhat.com",
    license="GPLv3+",
    url="https://github.com/thoth-station/report-visualization",
    download_url="https://pypi.org/project/thoth-report-visualization",
